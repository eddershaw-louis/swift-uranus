...
## Generate a video of the xy images for this simulation
## (These images will always exist for a simulation that has been run through plot_snapshots.py)
os.system("ffmpeg -framerate {1} -pattern_type glob -i 'simulations/{0}/xy/*.png' -c:v libx264 simulations/{0}/xy_animation.mp4".format(simulation_name, framerate))
...
if (len(glob.glob('simulations/{0}/xz/*.png'.format(simulation_name)))) > 0:
	#os.system("ffmpeg -framerate {1} -pattern_type glob -i 'simulations/{0}/xz/*.png' -c:v libx264 simulations/{0}/xz_animation.mp4".format(simulation_name, framerate))
	pass
...
if (len(glob.glob('simulations/{0}/yz/*.png'.format(simulation_name)))) > 0:
	#os.system("ffmpeg -framerate {1} -pattern_type glob -i 'simulations/{0}/yz/*.png' -c:v libx264 simulations/{0}/yz_animation.mp4".format(simulation_name, framerate))
	pass
...
if (len(glob.glob('simulations/{0}/xy_xz/*.png'.format(simulation_name)))) > 0:
	os.system("ffmpeg -framerate {1} -pattern_type glob -i 'simulations/{0}/xy_xz/*.png' -c:v libx264 simulations/{0}/xy_xz_animation.mp4".format(simulation_name, framerate))
	pass
...
if (len(glob.glob('simulations/{0}/xy_yz/*.png'.format(simulation_name)))) > 0:
	os.system("ffmpeg -framerate {1} -pattern_type glob -i 'simulations/{0}/xy_yz/*.png' -c:v libx264 simulations/{0}/xy_yz_animation.mp4".format(simulation_name, framerate))
	pass
...
if (len(glob.glob('simulations/{0}/xy_xz_yz/*.png'.format(simulation_name)))) > 0:
	os.system("ffmpeg -framerate {1} -pattern_type glob -i 'simulations/{0}/xy_xz_yz/*.png' -c:v libx264 simulations/{0}/xy_xz_yz_animation.mp4".format(simulation_name, framerate))
	pass
