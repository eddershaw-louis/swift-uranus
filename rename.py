...
analysis_base_filepath = "/home/hd20558/files/analysis/simulations"
#
#
...
## Get the old and new filepaths to the analysis files
analysis_filepath_old = "{0}/{1}".format(analysis_base_filepath, simulation_name_old)
analysis_filepath_new = "{0}/{1}".format(analysis_base_filepath, simulation_name_new)

## Rename the analysis directory for this simulation
os.system("mv {0}/ {1}/".format(analysis_filepath_old, analysis_filepath_new))
